...
export default function Knife({ className, transform }: IconProps) {
  return (
    <svg
    ...
    >
      ...
      <g clipPath="url(#knife_icon_1)">
        <g clipPath="url(#knife_icon_2)">
          <path
      ...
      <defs>
        <clipPath id="knife_icon_1">
          <rect width="53.0001" height="45" fill="currentColor" transform="translate(2 6)" />
        </clipPath>
        <clipPath id="knife_icon_2">
          <rect width="53.0001" height="45" fill="currentColor" transform="translate(2 6)" />
        </clipPath>
      </defs>
    </svg>
